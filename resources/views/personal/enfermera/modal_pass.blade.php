<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-update-{{$enfermera->id_enfermera}}">
...
<script>
	...
	function myFunction() {
		...
		var id_user	  = {{$enfermera->id_doctor}};
		...
		if(new_pass.length < 6 ||  new_pass1.length < 6){
			...
			$.ajax({
				...
				success: function (data) {
					$("#modal-update-"+{{$enfermera->id_doctor}}).modal("hide");
					alert(data);
				},
				error:function (data) {
