<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-delete-{{$enf->id_enfermera}}">
	{{Form::Open(array('action'=>array('EnfermeraController@destroy',$enf->id_enfermera),'method'=>'delete'))}}
