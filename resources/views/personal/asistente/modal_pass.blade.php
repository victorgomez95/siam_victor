<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-update-{{$asistente->id_asistente}}">
...
<script>
	...
	function myFunction() {
		...
		var id_user	  = {{$asistente->id_doctor}};
		...
		if(new_pass.length < 6 ||  new_pass1.length < 6){
			...
			$.ajax({
				...
				success: function (data) {
					$("#modal-update-"+{{$asistente->id_doctor}}).modal("hide");
					alert(data);
				},
				error:function (data) {
