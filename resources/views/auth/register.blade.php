                        ...
                        <div class="tab-pane active" id="1">
                            ...
                            <div class="form-group{{ $errors->has('anio_fundacion') ? ' has-error' : '' }}">
                                ...
                                <div class="cols-sm-10">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                                        <input type="month" class="form-control" name="anio_fundacion" id="anio_fundacion" value="{{ old('anio_fundacion') }}" placeholder="2017" required/>
                                    </div>
                            ...
                            <div class="form-group{{ $errors->has('rfc') ? ' has-error' : '' }}">
                                <label for="apellidos" class="cols-sm-2 control-label">RFC</label></label>
                                <div class="cols-sm-10">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                                        <input type="text"  class="form-control" name="rfc" id="rfc" value="{{ old('rfc') }}" placeholder="Persona moral"  pattern="^(([A-Z]|[a-z]|\s){1})(([A-Z]|[a-z]){2})([0-9]{6})((([A-Z]|[a-z]|[0-9]){3}))" minlength="12" maxlength="12" required/>
                                    </div>
                                    @if ($errors->has('rfc'))
                                        <span class="help-block">
