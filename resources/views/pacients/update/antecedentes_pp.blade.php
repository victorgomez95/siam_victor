...
<div  class="row">
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			...
			<input class="form-control" placeholder="ingrese antecedente" name="enactuales" id="enactuales" value="{{$antecedentes_pp->enactuales}}"></input>
		</div>
	</div>
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			<label for="nombre">2.-Quirúrgicos</label>
			<input class="form-control" placeholder="ingrese antecedente" name="quirurjicos" id="quirurjicos" value="{{$antecedentes_pp->quirurjicos}}"></input>
		</div>
	</div>
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			<label for="nombre">3.-Transfusionales</label>
			<input class="form-control" placeholder="ingrese antecedente" name="transfuncionales" id="transfuncionales" value="{{$antecedentes_pp->transfuncionales}}"></input>
		</div>
	</div>
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			<label for="nombre">4.-Alergias</label>
			<input class="form-control" placeholder="ingrese antecedente" name="alergias" id="alergias" value="{{$antecedentes_pp->alergias}}"></input>
		</div>
	</div>
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			<label for="nombre">5.-Traumáticos</label>
			<input class="form-control" placeholder="ingrese antecedente" name="traumaticos" id="traumaticos" value="{{$antecedentes_pp->traumaticos}}"></input>
		</div>
	</div>
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			<label for="nombre">6.-Hospitalizaciones previas</label>
			<input class="form-control" placeholder="ingrese antecedente" name="hosprevias" id="hosprevias" value="{{$antecedentes_pp->hosprevias}}"></input>
		</div>
	</div>
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			<label for="nombre">7.-Adicciones</label>
			<input class="form-control" placeholder="ingrese antecedente" name="adicciones" id="adicciones" value="{{$antecedentes_pp->adicciones}}"></input>
		</div>
	</div>
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			...
			<input class="form-control" placeholder="ingrese antecedente" name="otros" id="otros_pp" value="{{$antecedentes_pp->otros}}"></input>
		</div>
	</div>
</div>
