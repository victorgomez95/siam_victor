...
<div  class="row">
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			...
			@if($antecedentes_pnp->banio=="Diario")
				<label class="radio-inline"><input type="radio" name="banio" value="Diario" checked>Diario 			</label>
			@else
				<label class="radio-inline"><input type="radio" name="banio" value="Diario">Diario 					</label>
			@endif
			
			@if($antecedentes_pnp->banio=="C/3er día")
				<label class="radio-inline"><input type="radio" name="banio" value="C/3er día" checked>C/3er día 	</label>
			@else
				<label class="radio-inline"><input type="radio" name="banio" value="C/3er día">C/3er día 	</label>
			@endif
			
			@if($antecedentes_pnp->banio=="Irregular")
				<label class="radio-inline"><input type="radio" name="banio" value="Irregular" checked>Irregular 	</label>
			@else
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			...
			@if($antecedentes_pnp->dientes=="1/Día")
				<label class="radio-inline"><input type="radio" name="dientes" value="1/Día" checked>1/Día</label>
			@else
				<label class="radio-inline"><input type="radio" name="dientes" value="1/Día">1/Día</label>
			@endif
			@if($antecedentes_pnp->dientes=="2/Día")
				<label class="radio-inline"><input type="radio" name="dientes" value="2/Día" checked>2/Día</label>
			@else
				<label class="radio-inline"><input type="radio" name="dientes" value="2/Día">2/Día</label>
			@endif
			@if($antecedentes_pnp->dientes=="3/Día")
				<label class="radio-inline"><input type="radio" name="dientes" value="3/Día" checked>3/Día</label>
			@else
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			...
			@if($antecedentes_pnp->habitacion=="Urbana")
				<label class="radio-inline"><input type="radio" name="habitacion" value="Urbana " checked>Urbana 				</label>
			@else
				<label class="radio-inline"><input type="radio" name="habitacion" value="Urbana "		 >Urbana 				</label>
			@endif
			
			@if($antecedentes_pnp->habitacion=="Rural")
				<label class="radio-inline"><input type="radio" name="habitacion" value="Rural" checked>Rural 				</label>
			@else
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			...
			<input class="form-control" placeholder="ingrese antecedente" name="tabaquismo" value="{{$antecedentes_pnp->tabaquismo}}"></input>
		</div>
	</div>
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			<label for="nombre">6.-Alcoholismo</label>
			<input class="form-control" placeholder="ingrese antecedente" name="alcoholismo" value="{{$antecedentes_pnp->alcoholismo}}"></input>
		</div>
	</div>
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			...
			<input class="form-control" placeholder="ingrese antecedente" name="alimentacion" value="{{$antecedentes_pnp->alimentacion}}"></input>
		</div>
	</div>
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			<label for="nombre">8.-Deportes</label>
			<input class="form-control" placeholder="ingrese antecedente" name="deportes" value="{{$antecedentes_pnp->deportes}}"></input>
		</div>
	</div>
</div>
