...
<div  class="row">
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			...
			<textarea name="astenia_pacient" id="astenia_pacient" value="{{$antecedentes_sg->astenia_pacient}}">{{$antecedentes_sg->astenia_pacient}}</textarea>
		</div>
    </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			...
			<textarea name="adinamia_pacient"  id="adinamia_pacient" value="{{$antecedentes_sg->adinamia_pacient}}">{{$antecedentes_sg->adinamia_pacient}}</textarea>
		</div>
    </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			...
			<textarea name="anorexia_pacient" id="anorexia_pacient" value="{{$antecedentes_sg->anorexia_pacient}}">{{$antecedentes_sg->anorexia_pacient}}</textarea>
		</div>
    </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			...
			<textarea name="fiebre_pacient"  id="fiebre_pacient" value="{{$antecedentes_sg->fiebre_pacient}}">{{$antecedentes_sg->fiebre_pacient}}</textarea>
		</div>
    </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="form-group">
			...
			<textarea name="pPeso_pacient"  id="pPeso_pacient" value="{{$antecedentes_sg->pPeso_pacient}}">{{$antecedentes_sg->pPeso_pacient}}</textarea>
		</div>
    </div>
