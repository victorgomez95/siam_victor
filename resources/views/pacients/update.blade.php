                ...
                <table class="table table-striped table-bordered table-condensed table-hover">
                    ...
                    @foreach ($pacients as $pacient)
                        <tr>
                            ...
                            <td>{{ $pacient->curp}}</td>
                            <td align="center">
							  <button  type="button" value="<?php  echo $pacient->id?>"  class="btn btn-primary btn-sm"            							  data-toggle='modal' data-target='#myModal'>Exhibir detalles</button>
                            </td>
							<td align="center">
							  <a href="{{URL::action('PacientController@edit',$pacient->id)}}">
