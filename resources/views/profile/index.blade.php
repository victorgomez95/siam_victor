...
<div class="row">
    <div class="col-md-3">
        ...
        <div class="box-body box-profile">
            @if($usuario_perfil->logotipo != "N/A")
                <img class="img-rounded" id="myImg" alt="Usuario: {{$usuario_perfil->nombre}}" src="{{asset('assets/img_comp/'.$usuario_perfil->logotipo)}}" style="width:223px">
            @else
                <img class="profile-user-img img-responsive " alt="User profile picture" src="{{asset('assets/img/MONT&GO_icon.png')}}" style="border-style:none">
            @endif
            ...
            <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                    <b>Fundación</b>
                    <a class="pull-right"><span class="label label-primary">{{$usuario_perfil->fundacion}}</span></a>
                </li>

                <li class="list-group-item">
                    <b>Tipo de usuario</b> 
                    <a class="pull-right"><span class="label label-success">Administrador</span></a>
                </li>

                <li class="list-group-item">
                    <div align="center">
						<a href="{{URL::action('ProfileController@edit',$usuario_perfil->id_clinica)}}">
    ...
    <div class="col-md-9">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <strong><i class="fa fa-phone margin-r-5"></i> RFC</strong>
                <p class="text-muted">{{$usuario_perfil->rfc}}</p>
                <hr>

                <strong><i class="fa fa-user margin-r-5"></i> Nombre del administrador</strong>
                <p class="text-muted">{{$usuario_perfil->nombre_encargado}}</p>
                <hr>

                <strong><i class="fa fa-user margin-r-5"></i> Apellidos del administrador</strong>
                <p class="text-muted">{{$usuario_perfil->apellidos_encargado}}</p>
                <hr>

                <strong><i class="fa fa-user margin-r-5"></i> Sexo del administrador</strong>
                <p class="text-muted">{{$usuario_perfil->sexo_encargado}}</p>
                <hr>
    ...
    <div class="col-md-3">
        ...
        <div class="box-body box-profile">
            ...
            <ul class="list-group list-group-unbordered">
				...
				<li class="list-group-item">
                    <b>Tipo de cuenta</b>
                    <a class="pull-right"><span class="label label-success">Médico Clínica</span></a>
                </li>

                <li class="list-group-item">
                    <div align="center">
						<a href="{{URL::action('ProfileController@edit',$usuario_perfil->id_doctor)}}">
							<button type="button" class="btn btn-primary">&nbsp;&nbsp;&nbsp; Editar Perfil &nbsp;&nbsp;&nbsp;</button><br><br>
						</a>
    ...
    <div class="col-md-9">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <strong><i class="fa fa-phone margin-r-5"></i> Cédula Profesional</strong>
                <p class="text-muted">{{$usuario_perfil->cedula}}</p>
                <hr>
    ...
    <div class="col-md-3">
        ...
        <div class="box-body box-profile">
            ...
            <ul class="list-group list-group-unbordered">
				...
				<li class="list-group-item">
                    <b>Tipo de cuenta</b>
                    <a class="pull-right"><span class="label label-success">Médico Particular</span></a>
                </li>
    ...
    <div class="col-md-3">
        ...
        <div class="box-body box-profile">
            ...
            <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                    <b>Tipo de usuario</b> 
                    <a class="pull-right"><span class="label label-success">Enfermer@</span></a>
                </li>

                <li class="list-group-item">
                    <div align="center">
						<a href="{{URL::action('ProfileController@edit',$usuario_perfil->id_enfermera)}}">
							<button type="button" class="btn btn-primary">&nbsp;&nbsp;&nbsp; Editar Perfil &nbsp;&nbsp;&nbsp;</button><br><br>
						</a>                        
                    </div>
                </li>
